---
name: sg
description: Prepare the full git ship sequence - issue, branch, commit, push, PR, merge - as copy-paste commands for the staged changes. Use when the user wants to ship, commit, or open a pull request with git. Do not use when the user asked for jj; use the sj skill instead.
---
