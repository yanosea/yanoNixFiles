---
name: sj
description: Prepare the full jj (Jujutsu) ship sequence - issue, format, describe, bookmark, push, PR, merge, cleanup - as a runnable script covering every change in the working copy. Use when the user wants to ship with jj. Do not use when the user asked for plain git; use the sg skill instead.
---
