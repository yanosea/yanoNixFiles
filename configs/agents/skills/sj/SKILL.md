---
name: sj
description: Prepare the full jj (Jujutsu) ship sequence - issue, format, describe, bookmark, push, PR, merge, cleanup - as copy-paste commands for the working copy changes. Use when the user wants to ship with jj. Do not use when the user asked for plain git; use the sg skill instead.
---
