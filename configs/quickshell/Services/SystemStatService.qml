...
Singleton {
    ...
    // Configuration
    property int sleepDuration: 1000
    ...
    // Previous Bytes need to be stored as 'real' as they represent the total of bytes transferred
    // since the computer started, so their value will easily overflow a 32bit int.
