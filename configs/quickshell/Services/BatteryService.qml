...
Singleton {
    ...
    readonly property string batterySetterScript: Quickshell.shellDir + '/Bin/battery-manager/set-battery-threshold.sh'
    ...
    function applyChargingMode() {
        ...
        // uses toast messages so the flag is passed to suppress notifs
        command.push("-q");
