...
Item {
  ...
  width: root.icon === "" ? pill.width : (pillHeight + Math.max(0, pill.width - pillOverlap))
  height: pillHeight
  ...
  Rectangle {
    ...
    x: {
      if (root.icon === "") {
        // No icon, center the pill
        return 0
      }
      return oppositeDirection ? (iconCircle.x + iconCircle.width / 2) : // Opens right
    ...
    topLeftRadius: (root.icon === "" || !oppositeDirection) ? halfPillHeight : 0
    bottomLeftRadius: (root.icon === "" || !oppositeDirection) ? halfPillHeight : 0
    topRightRadius: (root.icon === "" || oppositeDirection) ? halfPillHeight : 0
    bottomRightRadius: (root.icon === "" || oppositeDirection) ? halfPillHeight : 0
    ...
    NText {
      ...
      color: {
        ...
        if (root.textColor && root.textColor !== "") {
          return root.textColor
        }
        return forceOpen ? Color.mOnSurface : Color.mPrimary
      }
      visible: revealed
  ...
  Rectangle {
    ...
    NIcon {
      ...
      pointSize: iconSize
      applyUiScale: false
      color: (root.iconColor && root.iconColor !== "") ? root.iconColor : (hovered ? Color.mOnTertiary : Color.mOnSurface)
      visible: root.icon !== ""
      // Center horizontally
