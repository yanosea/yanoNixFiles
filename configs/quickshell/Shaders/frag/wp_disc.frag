...
void main() {
  ...
  // Start the radius from -adjustedSmoothness, this ensures the disc is
  // completely hidden when progress=0
  ...
  float factor = smoothstep(radius - adjustedSmoothness,
                            radius + adjustedSmoothness, dist);
