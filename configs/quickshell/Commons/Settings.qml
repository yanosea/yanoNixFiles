...
Singleton {
    ...
    property bool isDebug: Quickshell.env("QS_DEBUG") === "1"

    // Define our app directories
    // Default config directory: ~/.config/quickshell
    // Default cache directory: ~/.cache/quickshell
    property string shellName: "quickshell"
    property string configDir: Quickshell.env("QS_CONFIG_DIR") || (Quickshell.env("XDG_CONFIG_HOME") || Quickshell.env("HOME") + "/.config") + "/" + shellName + "/"
    property string cacheDir: Quickshell.env("QS_CACHE_DIR") || (Quickshell.env("XDG_CACHE_HOME") || Quickshell.env("HOME") + "/.cache") + "/" + shellName + "/"
    ...
    property string settingsFile: Quickshell.env("QS_SETTINGS_FILE") || (configDir + "settings.json")

    property string defaultLocation: "Tokyo"
    property string defaultAvatar: Quickshell.env("XDG_CONFIG_HOME") + "quickshell/Assets/Avater/yanosea.png"
    property string defaultVideosDirectory: Quickshell.env("HOME") + "/google_drive/movs/rec"
    property string defaultWallpapersDirectory: Quickshell.env("XDG_DATA_HOME") + "/wallpapers"
    ...
    Component.onCompleted: {
        ...
        adapter.wallpaper.defaultWallpaper = defaultWallpapersDirectory + "/wall_8K.png";
    ...
    FileView {
        ...
        onLoadFailed: function (error) {
            if (error.toString().includes("No such file") || error === 2) {
                ...
                if (Quickshell.env("QS_SETTINGS_FALLBACK")) {
    ...
    FileView {
        ...
        path: Quickshell.env("QS_SETTINGS_FALLBACK") || ""
        adapter: Quickshell.env("QS_SETTINGS_FALLBACK") ? adapter : null
        printErrors: false
        watchChanges: false
    }
    JsonAdapter {
        ...
        property JsonObject colorSchemes: JsonObject {
            ...
            property string predefinedScheme: "Default"
    ...
    function upgradeWidget(widget) {
        ...
        // Delete deprecated user settings from the widget
