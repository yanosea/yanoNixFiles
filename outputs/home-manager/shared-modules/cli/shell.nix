          ...
          case "$1" in
            ...
            develop|dev)
              ...
              if [ $# -eq 1 ]; then
                ...
                echo -e "\033[31merror: develop accepts only one package\033[0m" >&2
                return 1
              fi
              ;;
            # build package
            ...
            run-once)
              ...
              if [ $# -eq 1 ]; then
                ...
                echo -e "\033[31merror: run-once accepts only one package\033[0m" >&2
                return 1
              fi
              ;;
            # show package info
            show|info)
              ...
              if [ $# -eq 1 ]; then
                ...
                echo -e "\033[31merror: show accepts only one package\033[0m" >&2
                return 1
              fi
              ;;
            # evaluate expression
            ...
            log)
              ...
              if [ $# -eq 1 ]; then
                ...
                echo -e "\033[31merror: log accepts only one package\033[0m" >&2
                return 1
              fi
              ;;
            # show help
            ...
            *)
              echo -e "\033[31merror: unknown subcommand '$1'\033[0m" >&2
